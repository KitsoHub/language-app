...
export const sentenceBuilderChallenges: Challenge[] = [
  ...
  //kalanga
  {
    id: 'sb-6',
    type: 'sentence-builder',
    instruction: "Build the sentence: 'Ndo zibheya Ikalanga'",
    correctOrder: ['Ndo', 'zibheya', 'Ikalanga'],
    wordBank: ['Ikalanga', 'Ndo', 'ithuta', 'zibheya', 'go'],
    languageId: 'kl',
    isLocked: false,
    points: 20,
    difficulty: 'hard'
  },
  {
    ...
    type: 'sentence-builder',
    instruction: "Build the sentence: 'I want to eat food'",
    correctOrder: ['Ndo', 'gaka', 'kudha',  'gadza'],
    wordBank: ['gadza', 'Ndo', 'gaka', 'kudha', 'nwa'],
    languageId: 'kl',
    isLocked: false,
    points: 20,
    difficulty: 'hard'
  },
  {
    ...
    type: 'sentence-builder',
    instruction: "Build the sentence: 'How are you today?'",
    correctOrder: ['wa','muka',' chino','nasi'],
    wordBank: ['muka','wa',' chino','nasi'],
    languageId: 'kl',
    isLocked: false,
    points: 20,
    difficulty: 'hard'
  },
  {
    ...
    type: 'sentence-builder',
    instruction: "Build the sentence: 'Thank you very much'",
    correctOrder: ['Ndo ', 'boka', 'kwazo'],
    wordBank: ['boka','Ndo ',  'kwazo'],
    languageId: 'kl',
    isLocked: false,
    points: 20,
    difficulty: 'hard'
  },
  {
    id: 'sb-10',
    type: 'sentence-builder',
    instruction: "Build the sentence: 'I like to speak Kalanga'",
    correctOrder: ['Ndoda ','ku',' lebeleka ','ikalanga'],
    wordBank: ['Ndoda ','ikalanga','ku ','lebeleka ',],
    languageId: 'kl',
    isLocked: false,
    points: 25,
    difficulty: 'hard'
